 ...
 *    `range`, `sort`). See `api-guides/boletin-oficial-del-estado/debug-notes.md` →
 ...
 *
 * Place this file at api-guides/boletin-oficial-del-estado/helper.ts (alongside guide.md)
 * to use it alongside the Boletín Oficial del Estado guide.
 */
